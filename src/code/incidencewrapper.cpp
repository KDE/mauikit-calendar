...
static QString formatSpelloutDuration(const KCalendarCore::Duration &duration, const KFormat &format, bool allDay)
{
...
{
    return formatSpelloutDuration(duration(), m_format, allDay());
}
